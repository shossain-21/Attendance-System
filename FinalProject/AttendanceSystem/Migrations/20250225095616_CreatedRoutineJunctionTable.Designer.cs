...
namespace AttendanceSystem.Migrations
{
    ...
    [Migration("20250225095616_CreatedRoutineJunctionTable")]
    partial class CreatedRoutineJunctionTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AttendanceSystem.Routine", b =>
                {
                    ...
                    b.HasKey("DayId", "ScheduleId", "CourseId");
            ...
            modelBuilder.Entity("AttendanceSystem.Routine", b =>
                {
                    ...
                    b.HasOne("AttendanceSystem.Day", "Day")
                        .WithMany("Routines")
                        .HasForeignKey("DayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
